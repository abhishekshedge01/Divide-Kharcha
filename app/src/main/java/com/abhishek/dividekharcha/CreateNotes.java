...
public class CreateNotes extends AppCompatActivity {
    ...
    EditText edttoolbar,edtcontent,edtphoneno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtphoneno=findViewById(R.id.editphone);
        ...
        savebtton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    DocumentReference documentReference = firebaseFirestore.collection("notes").document(firebaseUser.getUid()).collection("myNotes").document(title);
